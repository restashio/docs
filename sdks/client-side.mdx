...
<CardGroup cols={2}>
  <Card title="NPM package" icon="npm" href="https://www.npmjs.com/package/@restash/client">
    Download and install the Restash client SDK from NPM
  </Card>
  <Card
    title="Source code"
    icon="github"
    href="https://github.com/restashio/restash-client"
  >
